...
export default class WorldDynamics {
  ...
  clip(value1: number, value2: number, switchTime: number, t: number) {
  ...
  reset() {
    ...
    this.PI = 1.65e9; //1.2
    this.BRN = 0.04; //2.2
    this.BRN1 = MODIFIER_NORMAL.BRN1; //2.3 <----- CHANGEABLE
    this.SWT1 = 1970; //2.4
    this.ECIRN = 1.0; //4.1
    this.NRI = 900e9; //8.2
    this.NRUN = 1.0; //9.1
    this.NRUN1 = MODIFIER_NORMAL.NRUN1; //9.2 <----- CHANGEABLE
    this.SWT2 = 1970; //9.3
    this.DRN = 0.028; //10.2
    this.DRN1 = MODIFIER_NORMAL.DRN1; //10.3 <--- CHANGEABLE
    this.SWT3 = 1970; //10.4
    this.LA = 135e6; //15.1
    this.PDN = 26.5; //15.2
    this.FC = 1.0; //19.1
    this.FC1 = MODIFIER_NORMAL.FCN1; //19.2 <------ CHANGEABLE
    this.FN = 1.0; //19.3
    this.SWT7 = 1970; //19.4
    this.CIAFN = 0.3; //22.1
    this.CII = 0.4e9; //24.2
    this.CIGN = 0.05; //25.1
    this.CIGN1 = MODIFIER_NORMAL.CIGN1; //25.2 <--- CHANGEABLE
    this.SWT4 = 1970; //25.3
    this.CIDN = 0.025; //27.1
    this.CIDN1 = MODIFIER_NORMAL.CIDN1; //27.2 <-- CHANGEABLE
    this.SWT5 = 1970; //27.3
    this.POLS = 3.6e9; //29.1
    this.POLI = 0.2e9; //30.2
    this.POLN = 1.0; //31.1
    this.POLN1 = MODIFIER_NORMAL.POLN1; //31.2 <---- CHANGEABLE
    this.SWT6 = 1970; //31.3
    this.CIAFI = 0.2; //35.2
  ...
  run(years: number, dt: number) {
    const untilYears = this.TIME + years;
